...
ActiveRecord::Schema.define(version: 20151216185146) do
  ...
  create_table "companies", force: :cascade do |t|
    ...
    t.string   "ancestry"
    t.boolean  "filial",                 default: false
  end

  add_index "companies", ["ancestry"], name: "index_companies_on_ancestry", using: :btree
